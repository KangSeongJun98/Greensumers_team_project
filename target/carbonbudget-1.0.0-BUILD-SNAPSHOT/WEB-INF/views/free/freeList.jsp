...
<body>
	...
	<section class="page-section" id="contact">
		<div class="container" style="margin-top: 100px;">
			<div class="card-body col-12">
				...
				<!-- START : 검색 폼  -->
				<div class="row g-0 justify-content-md-center col-12" style="margin-left: 15%">
    ...
    <div class="col-lg-3"></div> <!-- 오른쪽 마진 추가 -->
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">
                        분류: ${free.boCategoryNm}
                    </h6>
                    <p class="card-text">
                        작성자: ${free.boWriter}<br>
                        등록일: ${free.boRegDate}<br>
                        조회수: ${free.boHit}
                    </p>
                </div>
            </div>
